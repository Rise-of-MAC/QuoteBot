...
var DocumentDAO = /** @class */ (function () {
    ...
    DocumentDAO.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DocumentDAO.prototype.getRandomQuote = function (n) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.collection.find().limit(n).toArray()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [2 /*return*/, (_a.sent()).map(function (it) { return (__assign(__assign({}, it), { _id: it._id.toString() })); })];
                }
            });
        });
    };
